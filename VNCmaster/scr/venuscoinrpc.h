...
#ifndef _venuscoinRPC_H_
#define _venuscoinRPC_H_ 1
...
enum RPCErrorCode
{
    ...
    // P2P client errors
    RPC_CLIENT_NOT_CONNECTED        = -9,  // venuscoin is not connected
...
/**
 * venuscoin RPC command dispatcher.
 */
class CRPCTable
{
private:
