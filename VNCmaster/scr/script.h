...
#ifndef H_venuscoin_SCRIPT
#define H_venuscoin_SCRIPT
 ...
 *  A CTxDestination is the internal data type encoded in a CvenuscoinAddress
 */
...
public:
    ...
    // Pre-version-0.6, venuscoin always counted CHECKMULTISIGs
